    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#conocimientos_habilidades").val(obj.data[0].conocimientos_habilidades);
                $("#experiencia").val(obj.data[0].experiencia);
            }
        });
    });
    ...
    $(document).ready(function() {
        ...
        $('#modificar').click(function() {
            var dataUser = {
                ...
                "conocimientos_habilidades": $("#conocimientos_habilidades").val(),
